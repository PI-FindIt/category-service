...
from protobuf.connections import category_service_models as service_pb2
import protobuf.category_service.category_pb2_grpc as service_pb2_grpc
...
class CategoryService(service_pb2_grpc.CategoryServiceServicer):
    async def CreateCategory(self, request: service_pb2.CreateCategoryRequest, context: grpc.ServicerContext) -> service_pb2.Category:
        ...

    async def GetCategory(self, request:service_pb2.CategoryId, context: grpc.ServicerContext) -> service_pb2.Category:
        ...

    async def UpdateCategory(self, request:service_pb2.UpdateCategoryRequest, context: grpc.ServicerContext) -> service_pb2.Category:
        ...

    async def DeleteCategory(self, request:service_pb2.CategoryId, context: grpc.ServicerContext) -> service_pb2.OperationResponse:
        ...
